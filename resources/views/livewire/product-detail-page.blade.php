  ...
  <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-800">
      <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
          <div class="flex flex-wrap -mx-4">
              <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage', $product->gambar) }}' }">
              ...
              <div class="w-full px-4 md:w-1/2">
                  <div class="lg:pl-20">
                      <div class="mb-8 [&>ul]:list-dics [&>ul]:ml-4">
                      ...
                      <div class="flex flex-wrap items-center gap-4">
                          <button wire:click='addTocart({{ $product->id }})' class="w-full p-4 bg-[#FDDE55] rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-[#FEEFAD] dark:bg-[#FEEFAD] dark:hover:bg-[#FDDE55]">
