          ...
          <div class="flex items-center gap-x-2">
            ...
            <div class="mt-1 flex items-center gap-x-2">
              @php
                  ...
                  } elseif ($order->status == 'delivered') { // Corrected the typo from 'deliverd' to 'delivered'
    ...
    <div class="md:w-3/4">
            ...
            <tr wire:key="{{$item->id}}">
              <td class="py-4">
                <div class="flex items-center">
                  <img class="h-16 w-16 mr-4" src="{{url('storage', $item->product->gambar)}}" alt="{{ $item->product->name}}">
      ...
      <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
        ...
        <div class="flex justify-between items-center">
          <div>
            <p>{{ $address->alamat}}, {{ $address->kota }}, {{ $address->kode_pos }}</p>
          </div>
          <div>
    ...
    <div class="md:w-1/4">
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between mb-2">
          <span>Subtotal</span>
          <span>{{Number::currency($item->order->total_bayar, 'IDR')}}</span>
        </div>
        <div class="flex justify-between mb-2">
          <span>Shipping</span>
        ...
        <div class="flex justify-between mb-2">
          ...
          <span class="font-semibold">{{Number::currency($item->order->total_bayar, 'IDR')}}</span>
        </div>
